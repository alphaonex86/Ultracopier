...
void OptionsWidget::setCatchPaste(bool catchPaste)
{
    ui->catchPaste->setChecked(catchPaste);
}
...
void OptionsWidget::on_catchPaste_toggled(bool checked)
{
    emit sendCatchPaste(checked);
}
