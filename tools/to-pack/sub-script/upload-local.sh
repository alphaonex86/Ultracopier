...
rsync -avrtz --compress-level=9 --rsh='ssh -p54973' --partial --progress /mnt/world/ultracopier-temp/*.dmg /mnt/world/ultracopier-temp/*.tar.xz root@ssh.first-world.info:/home/first-world.info/files/ultracopier/${ULTRACOPIER_VERSION}/ --timeout=120
RETURNA=$?
