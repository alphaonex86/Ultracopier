...
then
	#compil "supercopier-debug-windows-x86_64" 1 0 0 0 64 "-mtune=generic -march=nocona" 0 0 0 1 0
	#assemble "supercopier-debug" "${ARCHITECTURE}" 1 0 0 0 0 1
	#compil "supercopier-portable-windows-x86_64" 0 0 1 0 64 "-mtune=generic -march=nocona" 0 0 0 1 0
	#assemble "supercopier-portable" "${ARCHITECTURE}" 0 0 1 0 0 1
	compil "supercopier-windows-x86_64" 0 0 0 0 64 "-mtune=generic -march=nocona" 0 0 0 1 0
...
then
	compil "supercopier-ultimate-windows-x86_64" 0 0 0 0 64 "-mtune=generic -march=nocona" 1 0 0 1 0
    ...
    compil "supercopier-ultimate-core2-windows-x86_64" 0 0 0 0 64 "-msse -msse2 -msse3 -march=core2" 1 0 0 1 0
    assemble "supercopier-ultimate-core2" "${ARCHITECTURE}" 0 0 0 1 0 1
    compil "supercopier-ultimate-core-i-windows-x86_64" 0 0 0 0 64 "-msse -msse2 -msse3 -march=core2" 1 0 0 1 0
    assemble "supercopier-ultimate-core-i" "${ARCHITECTURE}" 0 0 0 1 0 1
    compil "supercopier-ultimate-k8-windows-x86_64" 0 0 0 0 64 "-msse -msse2 -march=k8" 1 0 0 1 0
