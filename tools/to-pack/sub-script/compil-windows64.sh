...
then
        compil "ultracopier-debug-real-windows-x86_64" 1 1 0 0 64 "-mtune=generic -march=nocona" 0 0 0
	assemble "ultracopier-debug-real" "${ARCHITECTURE}" 1 1 0 0 0
fi
if [ ${COMPIL_NORMAL} -eq 1 ]
then
	compil "ultracopier-debug-windows-x86_64" 1 0 0 0 64 "-mtune=generic -march=nocona" 0 0 0
	...
	compil "ultracopier-portable-windows-x86_64" 0 0 1 0 64 "-mtune=generic -march=nocona" 0 0 0
	assemble "ultracopier-portable" "${ARCHITECTURE}" 0 0 1 0 0
	compil "ultracopier-windows-x86_64" 0 0 0 0 64 "-mtune=generic -march=nocona" 0 0 0
	assemble "ultracopier" "${ARCHITECTURE}" 0 0 0 0 0
        compil "ultracopier-debug-static-windows-x86_64" 1 0 0 0 64 "-mtune=generic -march=nocona" 0 0 1
	assemble "ultracopier-debug-static" "${ARCHITECTURE}" 1 0 0 0 1
        compil "ultracopier-debug-portable-static-windows-x86_64" 1 0 1 0 64 "-mtune=generic -march=nocona" 0 0 1
	assemble "ultracopier-debug-portable-static" "${ARCHITECTURE}" 1 0 1 0 1
        compil "ultracopier-portable-static-windows-x86_64" 0 0 1 0 64 "-mtune=generic -march=nocona" 0 0 1
	assemble "ultracopier-portable-static" "${ARCHITECTURE}" 0 0 1 0 1
        compil "ultracopier-static-windows-x86_64" 0 0 0 0 64 "-mtune=generic -march=nocona" 0 0 1
	assemble "ultracopier-static" "${ARCHITECTURE}" 0 0 0 0 1
fi

if [ ${COMPIL_ULTIMATE} -eq 1 ]
then
	compil "ultracopier-ultimate-windows-x86_64" 0 0 0 0 64 "-mtune=generic -march=nocona" 1 0 0
...
then
	compil "ultracopier-windows-x86_64-for-plugins" 0 0 0 0 64 "-mtune=generic -march=nocona" 0 1 0
	compil "ultracopier-debug-windows-x86_64-for-plugins" 1 0 0 0 64 "-mtune=generic -march=nocona" 0 1 0
