...
#assemble "${TARGETTEMPTEST}" "${ARCHITECTURE}" 1 1 0 0 0
...
compil "${TARGETTEMPTEST}-windows-${ARCHITECTURE}" 1 0 0 0 32 "-g -mtune=generic -march=i686" 0 0 0 0
assemble "${TARGETTEMPTEST}" "${ARCHITECTURE}" 1 0 0 0 0
