...
then
	compil "ultracopier-debug-real-windows-x86" 1 1 0 0 32 "-g -mtune=generic -march=i686" 0 0 0 0 0
	assemble "ultracopier-debug-real" "${ARCHITECTURE}" 1 1 0 0 0 0
fi

if [ ${COMPIL_NORMAL} -eq 1 ]
then
	#compil "supercopier-debug-windows-x86" 1 0 0 0 32 "-mtune=generic -march=i686" 0 0 0 1 0
	#assemble "supercopier-debug" "${ARCHITECTURE}" 1 0 0 0 0 1
	compil "supercopier-portable-windows-x86" 0 0 1 0 32 "-mtune=generic -march=i686" 0 0 0 1 0
	assemble "supercopier-portable" "${ARCHITECTURE}" 0 0 1 0 0 1
	compil "supercopier-windows-x86" 0 0 0 0 32 "-mtune=generic -march=i686" 0 0 0 1 0
	assemble "supercopier" "${ARCHITECTURE}" 0 0 0 0 0 1

	compil "ultracopier-debug-windows-x86" 1 0 0 0 32 "-mtune=generic -march=i686" 0 0 0 0 0
	...
	compil "ultracopier-portable-windows-x86" 0 0 1 0 32 "-mtune=generic -march=i686" 0 0 0 0 0
	assemble "ultracopier-portable" "${ARCHITECTURE}" 0 0 1 0 0 0
	#compil "ultracopier-portableapps-windows-x86" 0 0 1 1 32 "-mtune=generic -march=i686" 0 0 0 0 0
	#assemble "ultracopier-portableapps" "${ARCHITECTURE}" 0 0 1 0 0 0
	compil "ultracopier-windows-x86" 0 0 0 0 32 "-mtune=generic -march=i686" 0 0 0 0 0
	assemble "ultracopier" "${ARCHITECTURE}" 0 0 0 0 0 0
	#compil "ultracopier-debug-static-windows-x86" 1 0 0 0 32 "-mtune=generic -march=i686" 0 0 1 0 0
	#assemble "ultracopier-debug-static" "${ARCHITECTURE}" 1 0 0 0 1 0
	#compil "ultracopier-debug-portable-static-windows-x86" 1 0 1 0 32 "-mtune=generic -march=i686" 0 0 1 0 0
	#assemble "ultracopier-debug-portable-static" "${ARCHITECTURE}" 1 0 1 0 1 0
	#compil "ultracopier-portable-static-windows-x86" 0 0 1 0 32 "-mtune=generic -march=i686" 0 0 1 0 0
	#assemble "ultracopier-portable-static" "${ARCHITECTURE}" 0 0 1 0 1 0
	#compil "ultracopier-static-windows-x86" 0 0 0 0 32 "-mtune=generic -march=i686" 0 0 1 0 0
	#assemble "ultracopier-static" "${ARCHITECTURE}" 0 0 0 0 1 0
fi

if [ ${COMPIL_ULTIMATE} -eq 1 ]
then
	compil "supercopier-ultimate-windows-x86" 0 0 0 0 32 "-mtune=generic -march=i686" 1 0 0 1 0
	assemble "supercopier-ultimate" "${ARCHITECTURE}" 0 0 0 1 0 1

	compil "supercopier-ultimate-portable-windows-x86" 0 0 1 0 32 "-mtune=generic -march=i686" 1 0 0 1 0
	assemble "supercopier-ultimate-portable" "${ARCHITECTURE}" 0 0 1 1 0 1
	compil "ultracopier-ultimate-portable-windows-x86" 0 0 1 0 32 "-mtune=generic -march=i686" 1 0 0 0 0
	assemble "ultracopier-ultimate-portable" "${ARCHITECTURE}" 0 0 1 1 0 0

	compil "ultracopier-ultimate-windows-x86" 0 0 0 0 32 "-mtune=generic -march=i686" 1 0 0 0 0
	assemble "ultracopier-ultimate" "${ARCHITECTURE}" 0 0 0 1 0 0
	#compil "ultracopier-ultimate-sse2-windows-x86" 0 0 0 0 32 "-msse -msse2" 1 0 0 0 0
	#assemble "ultracopier-ultimate-sse2" "${ARCHITECTURE}" 0 0 0 1 0 0
	#compil "ultracopier-ultimate-sse3-windows-x86" 0 0 0 0 32 "-msse -msse2 -msse3" 1 0 0 0 0
	#assemble "ultracopier-ultimate-sse3" "${ARCHITECTURE}" 0 0 0 1 0 0
	#compil "ultracopier-ultimate-pentium3-windows-x86" 0 0 0 0 32 "-msse -march=pentium3" 1 0 0 0 0
	#assemble "ultracopier-ultimate-pentium3" "${ARCHITECTURE}" 0 0 0 1 0 0
	#compil "ultracopier-ultimate-pentium4-windows-x86" 0 0 0 0 32 "-msse -march=pentium4" 1 0 0 0 0
	#assemble "ultracopier-ultimate-pentium4" "${ARCHITECTURE}" 0 0 0 1 0 0

    compil "ultracopier-ultimate-core2-windows-x86" 0 0 0 0 32 "-msse -msse2 -msse3 -march=core2" 1 0 0 0 0
    assemble "ultracopier-ultimate-core2" "${ARCHITECTURE}" 0 0 0 1 0 0
    compil "ultracopier-ultimate-core-i-windows-x86" 0 0 0 0 32 "-msse -msse2 -msse3 -march=core2" 1 0 0 0 0
    assemble "ultracopier-ultimate-core-i" "${ARCHITECTURE}" 0 0 0 1 0 0
    compil "ultracopier-ultimate-k8-windows-x86" 0 0 0 0 32 "-msse -msse2 -march=k8" 1 0 0 0 0
    assemble "ultracopier-ultimate-k8" "${ARCHITECTURE}" 0 0 0 1 0 0

    compil "supercopier-ultimate-core2-windows-x86" 0 0 0 0 32 "-msse -msse2 -msse3 -march=core2" 1 0 0 1 0
    assemble "supercopier-ultimate-core2" "${ARCHITECTURE}" 0 0 0 1 0 1
    compil "supercopier-ultimate-core-i-windows-x86" 0 0 0 0 32 "-msse -msse2 -msse3 -march=core2" 1 0 0 1 0
    assemble "supercopier-ultimate-core-i" "${ARCHITECTURE}" 0 0 0 1 0 1
    compil "supercopier-ultimate-k8-windows-x86" 0 0 0 0 32 "-msse -msse2 -march=k8" 1 0 0 1 0
    assemble "supercopier-ultimate-k8" "${ARCHITECTURE}" 0 0 0 1 0 1
