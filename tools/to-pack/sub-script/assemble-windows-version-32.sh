...
then
	...
	assemble "ultracopier-portableapps" "${ARCHITECTURE}" 0 0 1 0
...
then
	...
	assemble "ultracopier-ultimate-pentium3" "${ARCHITECTURE}" 0 0 0 1
	assemble "ultracopier-ultimate-pentium4" "${ARCHITECTURE}" 0 0 0 1
